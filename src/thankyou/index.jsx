                ...
                <div className="row">
                  <div className="col-md-8 col-12">
                    ...
                    <ul className="list-unstyled d-flex justify-content-center">
                      <li>
                        <a href="https://www.instagram.com/bluehousebb">
                          <img src={insta} alt="instagram" />
                        </a>
                      </li>
                      <li>
                        <a href="https://www.youtube.com/channel/UCHwb5_DHT9B3iysOexwyH9A">
                          <img src={youtube} alt="youtube" />
                        </a>
                      </li>
                      <li>
                        <a className="button" href="https://bluehouse.is/blog">
                          BLOG
                        </a>
                      </li>
                      <li>
                  ...
                  <div className="col-md-4 col-12">
                    ...
                    <ul className="list-unstyled d-flex justify-content-center">
                      <li>
                        <a href="https://www.facebook.com/bluehouseiceland">
                          <img src={fb} alt="facebook" />
                        </a>
                      </li>
                      <li>
                        <a href="https://api.whatsapp.com/send?phone=3547756480&text=&source=&data=">
