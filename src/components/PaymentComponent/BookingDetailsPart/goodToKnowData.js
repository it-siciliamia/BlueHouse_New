export const goodToKnowData = [
  {
    ...
    goodToKnow: [
      ...
      {
        description: "🚌 3-minute walk to the nearest bus stop.",
      },
      {
        description: "🚗 5-minute drive from the town center.",
      },
      {
        description: "🌌 A popular spot for Northern Lights viewing.",
      },
      {
        description: "🛏 Cozy and comfortable room for a relaxing stay.",
      },
      {
        description: "📺 Netflix TV available for your entertainment.",
      },
      {
        description: "🍽 Kitchen facilities available for your use.",
      },
      {
        description: "🧺 Bedding provided for a comfortable night's sleep.",
      },
      {
        description: "🏠 Located in a quiet and peaceful neighborhood.",
      },
    ],
  },
  {
    ...
    goodToKnow: [
      ...
      {
        description: "🚌 4-minute walk to the nearest bus stop.",
      },
      {
        description: "🚗 10-minute drive from the town center.",
      },
      {
        description: "✈️ 55-minute drive from the airport.",
      },
      {
        description: "🌌 A popular spot for Northern Lights viewing.",
      },
