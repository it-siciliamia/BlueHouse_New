    ...
    <div id="zcOptinSuccessPanel"></div>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="newsletterForm">
        ...
        <div className={s.partContent}>
          <p className={s.partTitle}>
            <WithTransLate text={"Your Name"} />
            {" *"}
          </p>
          <Controller
            control={control}
        ...
        <p className={s.warningText} style={{ marginBottom: "15px" }}>
          <WithTransLate text={"*Required fields"} />
        </p>
        <div className={s.customCheckbox}>
          <input
            ...
            id="customCheckbox"
            ref={checkboxRef}
            onChange={handleAproveSendData}
          />
          <label htmlFor="customCheckbox"></label>
          <p className={s.warningText}>
            <WithTransLate
              text={`I agree to recive newsletters and
            updates from Blue House and consent to the collection and use of my
            First name, Last name and email for this purpose. I understand that I can unsudscribe
            at any time.`}
            />{" "}
            <Link to="/privacy-and-policy" className={s.policyText}>
