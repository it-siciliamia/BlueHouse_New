  ...
  return (
    <div className={classes.container}>
      <div className="service">
        <img src={view} className={classes.icons} alt="view" />
        <span className={classes.iconsDesc}>
          Popular Spot for Northern Lights
        </span>
      </div>
      <div className="service">
        <img src={wifi} className={classes.icons} alt="wifi" />
        <span className={classes.iconsDesc}>Free WIFI</span>
      </div>
      <div className="service">
        <img src={bus} className={classes.icons} alt="bus" />
        <span className={classes.iconsDesc}>3 Min Walk to Bus Stop</span>
      </div>
      <div className="service">
        <img src={car} className={classes.icons} alt="car" />
        <span className={classes.iconsDesc}>5 Min Drive from Town</span>
      </div>
      <div className="service">
        <img src={airplane} className={classes.icons} alt="airplane" />
        <span className={classes.iconsDesc}>45 Min Drive from Airport</span>
      </div>
      <div className="service">
        <img src={clock} className={classes.icons} alt="clock" />
