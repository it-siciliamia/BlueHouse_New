          ...
          {!isMobile && (
            <button
              ...
              style={{
                ...
                webkitBoxShadow: "0px 13px 5px -1px rgba(0,0,0,0.45)",
                MozBoxShadow: "0px 13px 5px 1px rgba(0,0,0,0.45)",
                boxShadow: "0px 2.5px 5px 1px rgba(0,0,0,0.45)",
                right: "10px",
                zIndex: 2,
              }}
            >
              <RiFullscreenLine style={{ width: "30px", height: "30px", color:"#3B5998", strokeWidth:"1" }} />
            </button>
          )}
        </div>
      </div>
        ...
        {!isMobile ? (
          <>
            ...
            {weather && (
              ...
              >
                <WeatherCard temperature={weather.main.temp} atmosphere={weather.clouds.all}/>
              </div>
            )}
          </>
        ) : (
