...
const getImagesByCategory = (category) => {
  switch (category) {
    ...
    case "Blue House":
      return [BlueHouse01, BlueHouse02, BlueHouse04, BlueHouse05, BlueHouse06, BlueHouse07];
    case "Green House":
      return [GreenHouse01, GreenHouse02, GreenHouse03, GreenHouse04, GreenHouse05, GreenHouse06];
    case "GNL":
