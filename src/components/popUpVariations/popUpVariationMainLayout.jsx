...
export default function PopUpVariationMainLayout({
  ...
  const popUpContent = window.innerWidth > 600 ? popUpLargeContent : popUpSmallContent;
...
PopUpVariationMainLayout.propTypes = {
  ...
  originalSideImageWidth: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
  imageSrcReplace: PropTypes.string.isRequired,
  Logo: PropTypes.string.isRequired,
  title: PropTypes.string.isRequired,
  imgSrc: PropTypes.string.isRequired,
  popUpLargeContent: PropTypes.node.isRequired,
  popUpSmallContent: PropTypes.node.isRequired,
};
