...
function Newsletter() {
  ...
  return (
    <form className={s.container} onSubmit={handleSubmit(onSubmit)} noValidate>
      <h2 className={s.title}><WithTransLate text="Sign up to the BH newsletter to get our updates from Iceland" /></h2>
      ...
      <div className={s.inputWrapper}>
        ...
        <button type="submit" disabled={isSubmitting} className={s.submit}><WithTransLate text="Sign up" /></button>
      </div>
    </form>
  )
}
