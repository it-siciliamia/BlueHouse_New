...
const Quote = ({ side }) => {
  return (
    <div
      className="w-full"
      style={{ textAlign: `${side === "left" ? "left" : "end"}`, padding: "0 1.25rem" }}
    >
      <svg
        className={`${side === "left" ? "rotate-0" : "rotate-180"} quote`}
        width="49"
        height="33"
        viewBox="0 0 49 33"
        fill="none"
...
function Aboutus() {
  ...
  const handlePrevious = () => {
    setCurrentIndex((prevIndex) => (prevIndex - 1 + imgSources.length) % imgSources.length);
  };
  ...
  return (
    <div>
      ...
      <div className="max-w-999px min-768px-px-1rem mx-auto">
        <section className="grid-cols-1fr_auto grid">
          <div className="socials">
            <a href="https://www.instagram.com/bluehousebb/" target="_blank" rel="noreferrer">
              <img src={instaIcon} title="Instagram" alt="instagram" />
            </a>
            ...
            <a
              ...
              rel="noreferrer"
            >
              <img src={Whatsapp} title="Whatsapp" alt="whatsapp" />
            </a>
            <a
      ...
      <div className="max-w-999px px-22px mx-auto">
        <section className="grid-cols-1fr_auto grid">
          <div className="vertical-text title me-3px mb-auto w-fit">ABOUT US</div>

          <div id="about-us_content" className="">
            <p className="paragraphs px-paragraphs text-center">
              Blue House Bed and Breakfast welcomes you to your home away from home in Reykjavik,
              Iceland. Simply put, we are a small team of globetrotters, passionate about
              unforgettable travel experiences. It’s an old, traditional, warm, charming Icelandic
              house.
            </p>
            <p className="paragraphs px-paragraphs text-center">
              Our houses are located on the scenic peninsula of Seltjarnarness, 5 minutes away from
              Reykjavik’s vibrant downtown. Begin your adventure around the world with us at Blue
              House B&B and stay at home surrounded by the friends you never knew you had.
            </p>
            ...
            <p className="paragraphs text-center">
              Peacefully set on Seltjarnarnes Peninsula, the Blue House B&B is a 5 minute drive from
              Reykjavik’s vibrant downtown and 20 minutes’ walk from the “Grótta Lighthouse”, the
              perfect spot to catch northern lights.
            </p>
            <p className="paragraphs text-center">
              The property is allocated over three houses and guests can choose from guestrooms or
              self-catering apartments. Parking is free of charge.
            </p>
          </div>
        </section>
        ...
        <section className="grid-cols-1fr_auto grid">
          <div className="vertical-text title me-3px mb-auto w-fit">MESSAGE FROM THE FOUNDER</div>
          <div id="about-us_content">
            ...
            <Quote side="left" />
            <p className="paragraphs text-center">
              For over 11 years I have been lucky to welcome guests from all over the globe.
            </p>
            <p className="paragraphs text-center">
              In 2006, I travelled to Iceland and fell in love with the small peninsula of
              Seltjarnarnes. In 2009 I renovated the Blue House, which became a popular travellers
              spot right away. Now we offer, in 3 locations, a wide selection of accommodations from
              Economy and Family rooms to the Grótta Northern Lights apartment, from where you can
              enjoy an incredible ocean view.
            </p>
            <p className="paragraphs text-center">
              The peaceful neighbourhood where the houses are located gives a glimpse of the
              stunning scenery Iceland has to offer. From here, you can enjoy the view over Esja
              Mountain, Faxafloi Bay, Snaefellsjökull glacier, Valhúsa Park, Grótta Lighthouse and
              the northern lights. If you want to experience the culture of Reykjavik, a 30-minutes
              walk is all it takes to get to the Downtown area and its museums, restaurants and
              bars.
            </p>
            <p className="paragraphs text-center">
              I hope that my team and I can welcome you soon and help you with your trip to Iceland!
              Remember that the cheapest price is only guaranteed through our website. If you have
              any questions, please use our live chat, send us an email or drop us a WhatsApp!
            </p>
            <Quote side="right" />
      ...
      <div className="max-w-999px px-22px mx-auto">
        <div className="flex-between">
          ...
          <div className="flex-column md-hidden">
            ...
            <div className="text-center text-xs">Click to call us</div>
          </div>

          <div className="flex-column md-hidden">
            <Support type={"whatsapp"} />
            <div className="title-xs text-center">WHATSAPP</div>
            <div className="text-center text-xs">Contact via WhatsApp</div>
          </div>
        </div>
      </div>
