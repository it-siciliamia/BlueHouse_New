      ...
      <div className={s.advantagesContainer}>
        <ul className={s.advantagesList}>
          <li className={s.advantagesItem}>
            <img src={dollarSign} alt="dollar icon" className={s.advantagesIcons} />
            <p className={s.advantagesText}>
              <WithTransLate text="Best Price Guarantee" />
            </p>
          </li>
          <li className={s.advantagesItem}>
            <img src={spotSign} alt="dollar icon" className={s.advantagesIcons} />
            <p className={s.advantagesText}>
              <WithTransLate text="Popular Spot for Northern Lights" />
            </p>
          </li>
          <li className={s.advantagesItem}>
            <img src={busSign} alt="dollar icon" className={s.advantagesIcons} />
            <p className={s.advantagesText}>
              <WithTransLate text="3 Min Walk to Bus Stop" />
            </p>
          </li>
          <li className={s.advantagesItem}>
            <img src={carSign} alt="dollar icon" className={s.advantagesIcons} />
            <p className={s.advantagesText}>
              <WithTransLate text="5 Min Drive from Town" />
            </p>
          </li>
          <li className={s.advantagesItem}>
            <img src={planeSign} alt="dollar icon" className={s.advantagesIcons} />
            <p className={s.advantagesText}>
              <WithTransLate text="45 Min Drive from Airport" />
            </p>
          </li>
          <li className={s.advantagesItem}>
            <img src={timeSign} alt="dollar icon" className={s.advantagesIcons} />
            <p className={s.advantagesText}>
